...
function setAutoFarmUI(){
  ...
  if(btn){
    btn.textContent=autoFarm?"🚜 Auto-Farm: ON":"🚜 Auto-Farm: OFF";
...
autoFarmBtn.style.cssText=(isTouchDevice()
  ?"position:fixed;right:calc(14px + env(safe-area-inset-right,0px));bottom:calc(300px + env(safe-area-inset-bottom,0px));font:11px system-ui,sans-serif;padding:6px 9px;white-space:nowrap"
  :"position:fixed;left:calc(14px + env(safe-area-inset-left,0px));top:calc(90px + env(safe-area-inset-top,0px));font:12px system-ui,sans-serif;padding:7px 12px"
 )+";z-index:40;background:rgba(20,25,36,.82);color:#e9c35b;border:1px solid #b89b52;border-radius:8px;cursor:pointer;display:none";
...
function setAutoHealUI(){
  ...
  if(btn){
    btn.textContent=autoHeal?"🧪 Auto-Heal: ON":"🧪 Auto-Heal: OFF";
...
autoHealBtn.style.cssText=(isTouchDevice()
  ?"position:fixed;right:calc(14px + env(safe-area-inset-right,0px));bottom:calc(344px + env(safe-area-inset-bottom,0px));font:11px system-ui,sans-serif;padding:6px 9px;white-space:nowrap"
  :"position:fixed;left:calc(14px + env(safe-area-inset-left,0px));top:calc(134px + env(safe-area-inset-top,0px));font:12px system-ui,sans-serif;padding:7px 12px"
 )+";z-index:40;background:rgba(80,170,95,.9);color:#fff;border:1px solid #8be09b;border-radius:8px;cursor:pointer;display:none";
