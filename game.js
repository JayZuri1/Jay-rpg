...
autoFarmBtn.style.cssText=(isTouchDevice()
  ?"position:fixed;right:calc(14px + env(safe-area-inset-right,0px));bottom:calc(300px + env(safe-area-inset-bottom,0px));width:50px;height:50px;border-radius:50%;font-size:22px;padding:0;display:flex;align-items:center;justify-content:center"
  :"position:fixed;left:calc(14px + env(safe-area-inset-left,0px));top:calc(90px + env(safe-area-inset-top,0px));font:12px system-ui,sans-serif;padding:7px 12px;border-radius:8px"
 )+";z-index:40;background:rgba(20,25,36,.82);color:#e9c35b;border:1px solid #b89b52;cursor:pointer;display:none";
...
autoHealBtn.style.cssText=(isTouchDevice()
  ?"position:fixed;right:calc(14px + env(safe-area-inset-right,0px));bottom:calc(360px + env(safe-area-inset-bottom,0px));width:50px;height:50px;border-radius:50%;font-size:22px;padding:0;display:flex;align-items:center;justify-content:center"
  :"position:fixed;left:calc(14px + env(safe-area-inset-left,0px));top:calc(134px + env(safe-area-inset-top,0px));font:12px system-ui,sans-serif;padding:7px 12px;border-radius:8px"
 )+";z-index:40;background:rgba(80,170,95,.9);color:#fff;border:1px solid #8be09b;cursor:pointer;display:none";
...
function startGame(){
 ...
 authScreen.style.display="none";
 logoutBtn.style.display="block";
 autoFarmBtn.style.display="block";
 autoHealBtn.style.display="block";
