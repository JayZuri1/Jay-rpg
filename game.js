...
(function setupTouchControls(){
  ...
  css.textContent=`
    ...
    body.touch #autoFarmBtn{left:calc(14px + env(safe-area-inset-left,0px));top:calc(14px + env(safe-area-inset-top,0px));font-size:11px;padding:6px 9px}
    body.touch #autoHealBtn{left:calc(14px + env(safe-area-inset-left,0px));top:calc(56px + env(safe-area-inset-top,0px));font-size:11px;padding:6px 9px}
