...
autoFarmBtn.style.cssText="position:fixed;left:calc(14px + env(safe-area-inset-left,0px));top:calc(90px + env(safe-area-inset-top,0px));z-index:40;background:rgba(20,25,36,.82);color:#e9c35b;font:12px system-ui,sans-serif;padding:7px 12px;border:1px solid #b89b52;border-radius:8px;cursor:pointer;display:none";
...
autoHealBtn.style.cssText="position:fixed;left:calc(14px + env(safe-area-inset-left,0px));top:calc(134px + env(safe-area-inset-top,0px));z-index:40;background:rgba(80,170,95,.9);color:#fff;font:12px system-ui,sans-serif;padding:7px 12px;border:1px solid #8be09b;border-radius:8px;cursor:pointer;display:none";
...
(function setupTouchControls(){
  ...
  css.textContent=`
    ...
    body.touch #autoFarmBtn{left:auto;top:auto;right:calc(14px + env(safe-area-inset-right,0px));bottom:calc(300px + env(safe-area-inset-bottom,0px));font-size:11px;padding:6px 9px;white-space:nowrap;z-index:40}
    body.touch #autoHealBtn{left:auto;top:auto;right:calc(14px + env(safe-area-inset-right,0px));bottom:calc(344px + env(safe-area-inset-bottom,0px));font-size:11px;padding:6px 9px;white-space:nowrap;z-index:40}
